...
class EntandoAppHelperTest {
    ...
    @Test
    public void testCombineEnvironmentVariables() {
        // Both empty
    ...
    @Test
    public void testSubtractEnvironmentVariables() {
        ...
        result = EntandoAppHelper.subtractEnvironmentVariables(null, b);
